                  ...
                  >
                    ...
                    <div className={`w-full pl-12 md:pl-0 md:w-1/2 ${isEven ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                      <div className="bg-card border border-border p-6 rounded-2xl hover:border-primary/30 transition-colors shadow-lg">
                        <span className="inline-block px-3 py-1 rounded-full bg-secondary text-primary text-xs font-bold tracking-widest mb-4">
                          {event.date}
                        </span>
                        ...
                        {event.imageUrl && (
                          <div className="rounded-xl overflow-hidden mt-4 bg-secondary">
                            <img 
                              src={event.imageUrl} 
                              alt={event.title} 
                              className="w-full h-auto object-cover max-h-[300px] hover:scale-105 transition-transform duration-500" 
                            />
                          </div>
                        )}
                      </div>
